# About-Me- PM and architect **enterprise-grade AI systems** and share practical frameworks that program managers, AI engineers, and transformation leaders can use right away.
...
I run the open-source **[Enterprise AI PM Playbook](https://github.com/Onkipi/enterprise-ai-pm-playbook)**, the repo where I share complete AI project templates, governance frameworks, agentic system designs, and real-world implementation patterns that help PMs and architects skip the noise and go straight to execution.
...
**LLMs**
`GPT-4o` `GPT-4o-mini` `Claude 3.5 Sonnet` `Gemini 1.5 Pro` `Llama 3` `Mistral`

**Vector & Graph Databases**
`pgvector` `Neo4j` `ChromaDB` `Pinecone` `FAISS` `Graphiti`

**Infrastructure & Deployment**
`FastAPI` `Kubernetes` `Docker` `AWS ECS` `Azure OpenAI` `Streamlit`

**AI Evaluation & Observability**
`RAGAS` `LangSmith` `Prometheus` `Grafana` `Power BI`

**Automation**
`n8n` `Automation Anywhere` `UiPath` `PyAutoGUI`

**Project Management**
`Jira` `Asana` `MS Project` `Power BI` `Visio`
...
| Document Intelligence | Government | Advanced RAG + Compliance Agent | 40 days → 6 hours review time |
| Multi-Agent Supply Chain | Logistics | AutoGen + Neo4j | $34M overstock reduction |
| AI Observability Platform | Enterprise Tech | LangSmith + RAGAS | <4hr drift detection |
| Voice AI Agent | Telecom Field Ops | Whisper + RAG + TTS | $4.2M annual productivity gain |
| BCP Intelligence System | Risk Management | RAG + Knowledge Graph | 40 min → 3 min incident lookup |
| AI PMO Transformation | Consulting | Full Stack AI + PMBOK | 45% → 80% on-time delivery |
...
*"The best AI projects are not the ones with the most sophisticated models. They are the ones where the right architecture meets disciplined execution and earns stakeholder trust."*
